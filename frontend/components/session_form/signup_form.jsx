    ...
    return (
      <div>
        <nav className="loginNav">
          <Link style={{color: 'white', margin: '15px'}} className="yeep" to="/">Yeep</Link>
        </nav>
        <div className="session-form-master">
          <div className="login-form-container">
            <form onSubmit={this.handleSubmit} className="login-form-box">
              <h2 className="heading">Sign Up for Yeep</h2>
              <h3>Connect with great local businesses</h3>
              <p className="legal-copy">By signing up, you agree to Yeep's Terms of Service and Private Policy.</p>
              {this.renderErrors()}
              <div className="login-form">
                <br/>
                <span className="first-lastname">
                ...
                <br/>
                <br/>
                <input type="text" value={this.state.zipcode} onChange={this.update('zipcode')} className="login-input" placeholder="ZIP Code"/>
                <br/>
                <label className="birthday">Birthday (optional)
